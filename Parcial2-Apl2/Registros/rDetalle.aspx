<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="rDetalle.aspx.cs" Inherits="Parcial2_Apl2.Registros.rDetalle" %>


<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   
    <div class="panel" style="background-color: #ff7101">
        <div class="panel-heading" style="font-family: Arial Black; font-size: 20px; text-align:center; color: Black">Registro de Detale</div>
    </div>
        ...
        <div class="form-horizontal col-md-12" role="form">
            ...
            <div class="container">
              <div class="form-group">
                <label for="PagoIdNumericUpDown" class="col-md-1   control-label input-sm" style="font-size: small">---</label>
                <div class="col-md-2 ">
                ...
                <div class="col-md-3 ">
                    ...
                    <%-- Paciente--%>
              <div class="form-group">
                    <label for="PAcienteTebox" class="col-md-1  control-label input-sm" style="font-size: small">-</label>
                    <div class="col-md-3">
            ...
            <%--TipoAnalisisId--%>
                     ...
                     <div class="form-group row">
                       ...
                       <div class="col-md-3">
                          <asp:DropDownList runat="server" AutoPostBack="true" ID="TiposAnalisisDropDown" CssClass="form-control input-sm"></asp:DropDownList>
                       </div>
                    <div class="col-md-1">
                          <asp:LinkButton runat="server" ID="LinkButton1"  class="btn btn-primary"   Text="+"></asp:LinkButton>
                    </div>

                       <div class="col-sm-1">

                        <asp:LinkButton runat="server" ID="AgregarGrid" class="btn btn-primary"   Text="Agregar" ></asp:LinkButton>
                    </div>
            ...
            <%--GRID--%>
              ...
              <div class="col-md-6 col-md-offset-6">
                 <div class="form-group">
                     <label for="MontoTextBox" class="col-md-2 control-label input-sm" style="font-size: small" >--</label>
                    <div class="col-md-6">
               ...
               <%-- Balance--%>
                    <div class="col-md-6 col-md-offset-6">
            <div class="form-group">
                <label for="BalanceTextBox" class="col-md-2 control-label input-sm" style="font-size: small" > -</label>
                <div class="col-md-6">
